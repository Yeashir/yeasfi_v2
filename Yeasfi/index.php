...
<div class="tetel-inner-page">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h2 id="page-<?php the_ID(); ?>" class="innerpage-titel"> News </h2>
            </div>
        </div>
    </div>
</div>
...
<section class="blog">
    <div class="container">
        <div class="row">
            ...
            <div class="post-content-innerpage inner-content-div col-md-12 col-lg-12">                          
    ...
    <?php } else { ?>  
        ...
        <div class="container">
            <div class="row">
                <div id="blogcontent" class="widecolumn bolg-page-desc col-md-12 col-lg-12">                  
                    <?php if (cs_get_option('blog-desc') != ""): ?>
                        <?Php echo wpautop(cs_get_option('blog-desc')) ?> 
                    <?php endif; ?>                   
                </div>
