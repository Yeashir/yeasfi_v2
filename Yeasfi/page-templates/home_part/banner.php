...
<?php if (cs_get_option('slider_switcher') == 0) { ?>    
    <section id="banner">
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12 bannereltable align-self-center">
                    <div class="row align-items-center bannerheight">
                        <div class="bannerelement col-12">
                            <div class="bannert1"><h1><?php echo $bannert1 = cs_get_option('bannert1'); ?></h1></div>
                            <div class="bannert2"><h2><?php echo $bannert2 = cs_get_option('bannert2'); ?></h2></div>
                            <?php if (cs_get_option('actionbtn') == 1) { ?>  
                                <a  class="applybtn" href="<?php echo cs_get_option('actionbtnurl'); ?>"><?php echo cs_get_option('actionbtntxt'); ?></a>
                            <?php }; ?>
                        </div>
                    </div>
                </div>                
        ...
        <div id="bannerbotomsec">
        <div class="container">
            <div class="row ">
                <div class="bannerelementd col-lg-6 col-md-12 align-self-center">
                    <img src="<?php echo get_template_directory_uri(); ?>/img/Opening-hours.png"                                                     
                         alt="<?php echo cs_get_option('keyword'); ?> Opening-hours" class="Opening-hours" aria-hidden="true">                   
                    <p class="opnhourbn"> <?php echo cs_get_option('openinghour'); ?>  </p>

                </div>
                <div class="bannerelementd col-lg-6 col-md-12 text-right align-self-center">    
                    <a  class="applybtnbannerelementd" href="/contact-us">CONTACT US</a>
                </div>
            </div>
        </div>                
                ...
                <div class="carousel-inner">
                    ...
                    if (!empty($group_items)) {
                        foreach ($group_items as $item) {
                            ...
                            ?>
                            <div id="item-<?php echo $count ?>" class="carousel-item slides <?php echo $tag; ?> ">
                                <div class="slide-<?php echo $count ?> slid-itemsingle">
                                    <div class="row ">
                                        <div class="col"></div>
                                        <div class="slidertext col-lg-8 col-md-12">
                                            <div class="row ">
                                                <div class="col-lg-8 col-md-12 align-self-end">
                                                    <h1><?php echo $title; ?></h1>        
                                                    <h3><?php echo $desc; ?></h3>
                                                </div>
                                                <div class="col-lg-3 col-md-12 align-self-center d-none d-lg-block">
                                                    <fieldset>
                                                        <legend align="center"><?php echo cs_get_option('actionbtntxt'); ?></legend>
                                                        <a  class="applybtn" href="tel:<?php echo cs_get_option('phone'); ?>"><?php echo cs_get_option('phone'); ?></a>
                                                    </fieldset>
                                                </div>
                                                <div class="col-lg-3 col-md-12 align-self-center d-lg-none d-md-block">                                                    
                                                    <a  class="applybtnmob" href="tel:<?php echo cs_get_option('phone'); ?>"><?php echo cs_get_option('actionbtntxt'); ?></a>                                                   
                                                </div>
